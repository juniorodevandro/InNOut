...
class WorkingHours extends Model {
    ...
    function getWorkedInterval() {
        [$t1, $t2, $t3, $t4] = $this->getTimes(); // [$t1, $t2, $t3, $t4] = $this->getTimes();
        ...
        return sumIntervals($part1, $part2);   // sumIntervals($part1, $part2);
    }
    ...
    function getExitTime() {
        [$t1,,, $t4] = $this->getTimes();  //[$t1,,, $t4] = $this->getTimes();  
        $workday = DateInterval::createFromDateString('8 hours'); //8 hours
